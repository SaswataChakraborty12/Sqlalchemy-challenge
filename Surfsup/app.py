...
#app routing ppt past 12 months
...
#app routing t obs past 12 months
...
#app routing for min, max, avg temp start date
...
#app routing for min, max, avg temp given start and end date
